...
OutputBaseFilename=Win2PDF-PDF2PNG-Plug-In
Compression=lzma
...
;Allow user to turn "Create PNG" on or off in the Win2PDF File Save window. Remove this to always apply.
;Root: HKCU; Subkey: "SOFTWARE\Dane Prairie Systems\{#MyWin2PDFPrinterName}"; ValueType:string; ValueName: "post action checkbox label"; ValueData: "Create PNG"; Flags: uninsdeletevalue

[Run]
Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; Description: "Configure Win2PDF PDF2PNG"; 

[Icons]
Name: "{group}\Configure Win2PDF PDF2PNG"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"
