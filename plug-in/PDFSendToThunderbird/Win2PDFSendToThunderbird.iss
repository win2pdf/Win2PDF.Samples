...
#define MyAppName "Win2PDF Send To Thunderbird Plug-In"
#define MyAppVersion "1.0"
#define MyAppPublisher "Dane Prairie Systems, LLC"
#define MyAppURL "https://www.win2pdf.com"
#define MyAppExeName "PDFSendToThunderbird.exe"
...
OutputBaseFilename=Win2PDF-Send-To-Thunderbird-Plug-In
Compression=lzma
...
;Allow user to turn "Send to Thunderbird" on or off in the Win2PDF File Save window. Remove this to always apply.
Root: HKCU; Subkey: "SOFTWARE\Dane Prairie Systems\{#MyWin2PDFPrinterName}"; ValueType:string; ValueName: "post action checkbox label"; ValueData: "Send To Thunderbird"; Flags: uninsdeletevalue
