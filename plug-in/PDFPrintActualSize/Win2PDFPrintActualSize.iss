...
#define MyAppName "Win2PDF Print Actual Size Plug-In"
#define MyAppVersion "1.0"
#define MyAppPublisher "Dane Prairie Systems, LLC"
#define MyAppURL "https://www.win2pdf.com"
#define MyAppExeName "PDFPrintActualSize.exe"
...
AppId={{E6335BD8-E18D-42B3-B0AF-813BC86576DB}
AppName={#MyAppName}
...
OutputBaseFilename=Win2PDF-Print-Actual-Size
Compression=lzma
...
;Allow user to turn "Print Actual Size" on or off in the Win2PDF File Save window. Remove this to always apply.
;Root: HKCU; Subkey: "SOFTWARE\Dane Prairie Systems\{#MyWin2PDFPrinterName}"; ValueType:string; ValueName: "post action checkbox label"; ValueData: "Print Actual Size"; Flags: uninsdeletevalue; Components: printer
...
[Run]
Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; Description: "Configure Win2PDF Print Actual Size"; 

[Icons]
Name: "{group}\Configure Win2PDF Print Actual Size"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"
