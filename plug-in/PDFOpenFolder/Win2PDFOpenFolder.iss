...
AppId={{4E2672AA-7F81-4458-AB76-C385A017DBAF}
AppName={#MyAppName}
...
OutputBaseFilename=Win2PDF-Open-Folder-Plug-In
Compression=lzma
...
;Allow user to turn "View Folder" on or off in the Win2PDF File Save window. Remove this to always apply.
Root: HKCU; Subkey: "SOFTWARE\Dane Prairie Systems\{#MyWin2PDFPrinterName}"; ValueType:string; ValueName: "post action checkbox label"; ValueData: "Open Folder"; Flags: uninsdeletevalue
