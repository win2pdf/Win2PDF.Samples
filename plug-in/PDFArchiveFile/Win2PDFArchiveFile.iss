...
OutputBaseFilename=Win2PDF-Archive-File-Plug-In
Compression=lzma
...
Source: "VB.NET\bin\Release\*.dll"; DestDir: "{app}"; Flags: ignoreversion
...
;Root: HKCU; Subkey: "SOFTWARE\Dane Prairie Systems\{#MyWin2PDFPrinterName}"; ValueType:string; ValueName: "post action checkbox label"; ValueData: "Archive File"; Flags: uninsdeletevalue

[Run]
Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; Description: "Configure Win2PDF Archive File Location"; 

[Icons]
Name: "{group}\Configure Win2PDF Archive File Location"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"
