...
OutputBaseFilename=Win2PDF-Reformat-As-Text
Compression=lzma
...
;Allow user to turn "Reformat As Text" on or off in the Win2PDF File Save window. Remove this to always apply.
Root: HKCU; Subkey: "SOFTWARE\Dane Prairie Systems\{#MyWin2PDFPrinterName}"; ValueType:string; ValueName: "post action checkbox label"; ValueData: "Reformat As Text"; Flags: uninsdeletevalue

[Run]
Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; Description: "Configure Win2PDF Reformat As Text"; 

[Icons]
Name: "{group}\Configure Win2PDF Reformat As Text"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"
