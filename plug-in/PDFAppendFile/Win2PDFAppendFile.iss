...
OutputBaseFilename=Win2PDF-Append-File-Plug-In
Compression=lzma
...
[Icons]
Name: "{group}\Configure Win2PDF Append File"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"
