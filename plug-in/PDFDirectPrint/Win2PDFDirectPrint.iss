...
OutputBaseFilename=Win2PDF-Direct-Print-Plug-In
Compression=lzma
...
;Allow user to turn "Log Print Events" on or off in the Win2PDF File Save window. Remove this to always apply.
;Root: HKCU; Subkey: "SOFTWARE\Dane Prairie Systems\{#MyWin2PDFPrinterName}"; ValueType:string; ValueName: "post action checkbox label"; ValueData: "PDF Direct Print"; Flags: uninsdeletevalue; Components: printer
...
[Run]
Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; Description: "Configure Win2PDF Direct Print"; 

[Icons]
Name: "{group}\Configure Win2PDF Direct Print"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"
