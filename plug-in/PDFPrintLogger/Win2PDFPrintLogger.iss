...
OutputBaseFilename=Win2PDF-Print-Logger-Plug-In
Compression=lzma
...
;Root: HKCU; Subkey: "SOFTWARE\Dane Prairie Systems\{#MyWin2PDFPrinterName}"; ValueType:string; ValueName: "post action checkbox label"; ValueData: "Log Print Events"; Flags: uninsdeletevalue
